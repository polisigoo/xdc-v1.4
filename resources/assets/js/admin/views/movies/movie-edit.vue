        ...
        <div class="actor-modal">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 cast">
                    ...
                    <div class="row">
                        <div class="col-6 col-lg-4 col-xl-3 mt-4 text-center" v-for="(item, key) in data.cast" :key="key">
                                    ...
                                    <div class="modal-body p-4">
                                        ...
                                        <div class="movieapi" v-if="movieedit">
                                            <div class="progress mt-2">
                                                <div class="progress-bar" role="progressbar" :style="{width: percentCompleted + '%', height:'6px' }" :aria-valuenow="percentCompleted" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
