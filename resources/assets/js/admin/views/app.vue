<template>
    <div class="app">
        ...
        <div class="col-12" v-if="show_alert_services"  style="z-index: 1;position: fixed;left: 0;bottom: 0;width: 100%;">

            <div class="alert alert-warning" role="alert" v-for=" (item, index) in data_services_error" v-if="!item.status">
                {{item.message}}
            </div>
