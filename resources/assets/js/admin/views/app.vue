...
<div class="app">
    ...
    <div class="col-12" v-if="show_alert_services" style="z-index: 10000;position: fixed;left: 0px;bottom: 0px;width: 100%;">
    ...
    <div class="custom-navbar fixed-top">
        <div class="navbar-content">
            ...
            <div class="hidden-sm-down logo">
                <img src="/images/logo.png" alt="logo" style="margin-top: 7px; height: 30px" width="130%">
