<template>
    <div>
            ...
            <div class="col-12 row">
                <div class="col-8">
                    <div class="group-btn">
                        ...
                        <router-link class="btn btn-sm btn-warning mr-3" role="button" :to="{name: 'create-user'}">Create New User</router-link>
                    </div>
                </div>
                <div class="col-4 pull-right">
                    <div class="pull-right" id="search">
                        <input class="form-control mr-sm-2" type="text" v-model="search_query" placeholder="Search"
                               @keyup="SEARCH">
                    </div>
                </div>
            </div>
        ...
        <div class="m-2" v-if="Object.keys(data).length  > 0">
                            ...
                            <div v-if="invoices !== null && !invoice_spinner_loading">
                                <div class="form-group">
                                    <div class="col-12">
                                        ...
                                        <h6 v-if="invoices.name === 'Monthly'">{{invoices.name}} for
                                            ${{invoices.amount}}/mo</h6>
                                        <h6 v-if="invoices.name === 'Yearly'"> {{invoices.name}} for
                                            ${{invoices.amount}}/y</h6>
                                        <hr>
                                    </div>
                                </div>
                            ...
                            <tr v-for="(item, index) in data_search.users" :key="index">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <router-link role="button" class="btn btn-sm btn-warning btn-sm mr-2"
                                                     :to="{name: 'edit-user',params:{id:item.id}}">Edit
                                        </router-link>
                                        <button class="btn btn-sm btn-danger btn-sm mr-2"
                                                @click="DELETE(item.id,index)">Delete
                                        </button>
                ...
                <div v-if="data_search.users === null || Object.keys(data_search).length === 0">
                    ...
                    <nav aria-label="pagination" class="m-4 p-1">
                        <ul class="pagination ">
                            ...
                            <li class="page-item" id="end">
                                <a class="page-link"
                                   @click="PAGINATION('/api/admin/get/users?page='+data.users.last_page)">End</a>
                            </li>
                        </ul>
                    </nav>
