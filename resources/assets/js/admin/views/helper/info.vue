<template>
    ...
    <div class="k1_manage_table">
        ...
        <div class="info mt-0 m-4">
            ...
            <hr>
            <p>The External Link Should End With .mp4/.webm for Movie/Episode & RTMP/M3u8 for Live Tv</p>
            <br>
            ...
            <p><strong>Stripe Manage</strong></p>
            <hr>
            <p>After you add the plan from stripe dashboard, you will see automatically the plan in setting -> stripe manage, you can active it in site or inactive
                <br>
