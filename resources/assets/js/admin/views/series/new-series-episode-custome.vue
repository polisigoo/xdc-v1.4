            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <input type="file" id="backdrop" name="backdrop" v-validate="'image'"
                                       @change="infoShow('backdrop','backropFileDetails')" class="inputfile" multiple>
                                <label id="backdropLabel" for="backdrop">Choose a backdrop
                                    <br>
                                    <p id="backropFileDetails"></p>
                                </label>
                        ...
                        <transition name="menu-popover">
                            <div class="embed-section" v-show="upload_type_is == 'embed' ">
    ...
    export default {
        ...
        methods: {
            MOVIEDB_API() {
                ...
                for (let i = 0; i < backdrop.files.length; i++) {
                    this.apiFormData.append("backdrop[]", backdrop.files[i]);
                }
                ...
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        axios.post("/api/admin/new/series/episode/details/custom", this.apiFormData)
                            .then(
                                response => {
