                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <input v-validate="'required|max:30'" name="name" class="form-control" v-model="name"
                    ...
                    <div class="col-12" v-if="cloud_type">
                        <div class="form-group">
                            <div class="col-12">
                            <button class="btn btn-md btn-warning" v-if="!disabled_button" @click="SERIES_CUSTOM()">Upload
                            </button>
