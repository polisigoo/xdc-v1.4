                ...
                <div class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in data.admins" :key="index">
                            <td>{{item.id}}</td>
                            <td>
                                <img :src="item.image" :alt="item.name" width="50" onError="this.onerror=null;this.src='/images/avatar.png';">
                            </td>
                            <td>{{item.name}}</td>
                            <td>
                                {{item.email}}
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <router-link role="button" class="btn btn-sm btn-warning btn-sm mr-2" :to="{name: 'admins-user-edit',params:{id:item.id}}">Edit</router-link>
