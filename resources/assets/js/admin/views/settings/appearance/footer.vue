    ...
    <div class="container theme">
        ...
        <div class="m-2" id="manage-panel">
            ...
            <div class="col-12 col-md-8">
                ...
                <div class="form-group">
                    <button v-if="!button_loading" @click="UPDATE" class="btn btn-sm btn-warning">Update</button>
                    <button v-if="button_loading" class="btn btn-sm btn-danger" disabled> </button>
                </div>
