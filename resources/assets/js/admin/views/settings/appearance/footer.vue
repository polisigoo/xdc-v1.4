        ...
        <div class="col-12 my-3 p-2">
            ...
            <div class="m-2" id="manage-panel">
                <ul class="nav nav-tabs">
                     <li class="nav-item">
                        <button class="nav-link btn btn-sm btn-warning" role="button" :to="{name: 'themes'}">Themes</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link btn btn-sm btn-warning" role="button" :to="{name: 'footer'}">Footer</button>
                    </li>
                </ul>
            </div>
