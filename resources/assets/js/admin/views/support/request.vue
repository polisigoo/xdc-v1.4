          ...
          <div class="col-12 col-sm-8 col-lg-8 offset-sm-2 p-sm-3 mt-5 profile-edit h-100">
            <div class="row">
              ...
              <div class="col-4 text-right">
                <span class="support-request re-open"  v-if="request_data.data.request.status === 1 && !button_loading" @click="UPDATE_STATUS">Open</span>
                <span class="support-request re-close" v-if="request_data.data.request.status === 0 && !button_loading"  @click="UPDATE_STATUS">Close</span>
                <span class="support-request re-close" v-if="button_loading === 'status'">Loading</span>
              </div>
            ...
            <div class="col-12 mt-5 reply-box" v-if="request_data.data.request.status !== 0">
              ...
              <div class="form-group">
                <button class="btn btn-warning" @click="SUBMIT_REPLY" v-if="!button_loading">SEND REPLY</button>
                <button class="btn btn-warning" @click="SUBMIT_REPLY" v-if="button_loading === 'reply'" disabled>LOADING</button>
              </div>
            </div>
