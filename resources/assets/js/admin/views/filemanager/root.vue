<template>
  ...
  <div class="k1_manage_table file-manager">
      ...
      <div class="col-12 col-md-6">
        <div class="group-btn">
          ...
          <div class="upload-file btn btn-sm btn-warning">
							Upload File
							<input type="file" id="file-upload" name="file-upload" @change="UPLOAD_FILES" multiple/>
						</div>
        </div>
      </div>
        ...
        .then(
          response => {
            if (response.status === 200) {
              ...
              this.data.folder.push({'path': path, 'name': path.substring(1) });
