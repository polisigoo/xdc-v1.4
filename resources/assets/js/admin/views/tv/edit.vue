        ...
        <div class="k1_manage_table">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <input class="form-control" v-model="data.data.name" type="text" placeholder="Channel name" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <input type="file" id="image" name="image" v-validate="'image'" @change="readImage('image','imageFileImage')" class="inputfile">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <input class="form-control" v-model="data.data.streaming_url" type="text" placeholder="HLS Tv Link" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-12">
                                <label for="presets">Select Presets</label>
                                <select class="form-control" id="presets" v-model="data.data.streaming_resolutions">
                                    <option v-for="(item, index) in presets" :key="index" :value="item.Resolution">{{item.Name}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-12">
                                <label for="transcoding">Transcoding To HLS</label>
                                <select class="form-control" id="transcoding" v-model="data.data.streaming_transcoding">
                                    <option :value="1">Yes
                                    </option>
                                    <option :value="0">No
                                    </option>
               ...
               <div class="form-group">
                            ...
                            <div class="col-12">
                                <select class="form-control" v-validate="'required'" name="tv-genre" v-model="data.data.genre">
                                    <option>Adult</option>
                                    <option>Animated </option>
                                    <option>Cooking</option>
                                    <option>DIY</option>
                                    <option>Documentary</option>
                                    <option>Dramality</option>
                        ...
                        <div class="form-group">
                            <div class="col-12 col-sm-12">
                                <button class="btn btn-sm btn-warning" @click="CHANNEL_DETAILS()">Upload</button>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get("/api/admin/get/channel/" + this.$route.params.id).then(resposne => {
