                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <select class="form-control" id="transcoding" v-model="transcoding">
                                    <option  :value="1">Yes
                                    </option>
                                    <option  :value="0">No
                                    </option>
                        ...
                        <div class="form-group" v-if="transcoding === 1">
                            <div class="col-12">
                                <label for="presets">Select Presets</label>
                                <select class="form-control" id="presets" v-model="new_presets">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <select class="form-control" v-validate="'required'" name="tv-genre" v-model="genre">
                                    <option>Adult</option>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="details_progress" v-if="details_progress">
                                    <div class="row">
                                        ...
                                        <div class="title">
                                            <h6>
                                                <strong>Upload channel details</strong>
                                            </h6>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            CHANNEL_DETAILS(name) {
                ...
                formData.append("resolution", this.new_presets);
                formData.append("transcoding", this.transcoding);
