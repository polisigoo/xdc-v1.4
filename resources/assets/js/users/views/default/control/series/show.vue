            ...
            <div class="show_item__body p-md-5">
                ...
                <div class="hidden-md-up  body__background-sm-down">
                    ...
                    <div v-if="data.season !== null">
                        ...
                        <router-link :to="{name: 'series-player-current', params: {series_id: data.series.id}}" v-if="data.series.player == 'default'">
                        ...
                        <router-link :to="{name: 'series-player-embed-current', params: {series_id: data.series.id}}" v-else>
                            <div class="play hidden-md-up">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px"
                                    viewBox="0 0 294.843 294.843" style="enable-background:new 0 0 294.843 294.843;" xml:space="preserve"
                                    width="75px" class="play-big-svg">
                        ...
                        <div class="col-12 col-md-8 mt-3 content-sm-down">
                            ...
                            <div class="col-12 p-0 mt-5 __btn-control" v-if="data.season !== null">
                                <div class="btn-group">
                                    ...
                                    <router-link :to="{name: 'series-player-embed-current', params: {series_id: data.series.id}}" v-else class="btn btn-primary btn-play"
                                        role="button">
                                        Watch Season 1 Ep 1
                                    </router-link>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4 col-xl-3 col-xxl-1.5 mt-4 mb-4 p-xs-3 p-md-0" v-for="(item, index) in data.season[show_season]"
                                        ...
                                        <div class="episode_contnet">
                                            <div class="backdrop">
                                                <router-link :to="{name: 'series-player-specific', params:{episode_number: item.id, series_id: data.series.id}}" v-if="item.type == 'local' || item.type == 'link' ">
                                                ...
                                                <router-link :to="{name: 'series-player-embed-specific', params:{episode_number: item.id, series_id: data.series.id}}" v-else>
                                                    <progressive-img :src="'/storage/backdrops/600_' + item.backdrop"
                                                                     :alt="item.name"
                                                                     :blur="0"
                                                                     v-if="item.cloud == 'local'"
