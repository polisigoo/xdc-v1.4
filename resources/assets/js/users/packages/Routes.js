...
let routes = [
...

    {
        ...
        path: '/app/watch/series/:episode_number/:series_id',
    ...
    },
    {
        ...
        path: '/app/watch/movie/embed/:id',
        component: require('../views/' + themeName + '/control/video-player/movie-player-embed'),
        meta: {
            userAuth: true,
            title: 'Movie Player'
...

    {
        ...
        path: '/app/watch/series/embed/:series_id',
        component: require('../views/' + themeName + '/control/video-player/series-player-embed-current'),
        meta: {
            userAuth: true,
            title: 'Series Player'
        }
    ...
    {
        name: 'series-player-embed-specific',
        path: '/app/watch/series/embed`/:episode_number/:series_id',
        component: require('../views/' + themeName + '/control/video-player/series-player-embed-specific'),
        meta: {
            userAuth: true,
            title: 'Series Player'
        }
